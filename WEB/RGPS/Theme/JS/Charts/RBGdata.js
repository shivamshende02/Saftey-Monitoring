...
$jscomp.polyfillIsolated = function (a, c, b, d) {
    ...
    null != c &&
        (a
            ? $jscomp.defineProperty($jscomp.polyfills, h, { configurable: !0, writable: !0, value: c })
            : c !== b &&
              ...
              $jscomp.defineProperty(d, h, { configurable: !0, writable: !0, value: c })));
};
$jscomp.polyfill(
...
(function (a) {
    "object" === typeof module && module.exports
        ...
        ? define("RBGcharts/modules/data", ["RBGcharts"], function (c) {
            a(c);
            a.RBGcharts = c;
            return a;
        })
    ...
    function c(a, c, h, q) {
        a.hasOwnProperty(c) || ((a[c] = q.apply(null, h)), "function" === typeof CustomEvent && window.dispatchEvent(new CustomEvent("RBGchartsModuleLoaded", { detail: { path: c, module: a[c] } })));
    }
    a = a ? a._modules : {};
    c(a, "Core/HttpUtilities.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, c) {
        const { doc: b } = a,
            ...
            I = {
                ajax: function (a) {
                    const c = { json: "application/json", xml: "application/xml", text: "text/plain", octet: "application/octet-stream" },
                    ...
                    b.onreadystatechange = function () {
                        ...
                        if (4 === b.readyState) {
                            if (200 === b.status) {
                                if ("blob" !== a.responseType && ((c = b.responseText), "json" === a.dataType))
                                    try {
                                        c = JSON.parse(c);
                                    } catch (B) {
                ...
                getJSON: function (a, b) {
                    I.ajax({ url: a, success: b, dataType: "json", headers: { "Content-Type": "text/plain" } });
                },
                post: function (a, c, h) {
                    const q = d("form", E({ method: "post", action: a, enctype: "multipart/form-data" }, h), { display: "none" }, b.body);
                    A(c, function (a, b) {
    ...
    c(a, "Extensions/Data.js", [a["Core/Chart/Chart.js"], a["Core/Defaults.js"], a["Core/Globals.js"], a["Core/HttpUtilities.js"], a["Core/Series/Point.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (
        a,
        c,
        h,
        q,
        ...
        class D {
            ...
            static rowsToColumns(f) {
                let a, k, n, e, g;
                if (f) for (g = [], k = f.length, a = 0; a < k; a++) for (e = f[a].length, n = 0; n < e; n++) g[n] || (g[n] = []), (g[n][a] = f[a][n]);
                return g;
            }
            constructor(a, l = {}, k) {
            ...
            getColumnDistribution() {
                ...
                l.forEach((f) => {
                    ...
                    for (p = 0; p < k; p++) l.hasReader(r[p]) || l.addColumnReader(void 0, r[p]);
                    c.push(l);
                    z++;
                });
                l = F[e || "line"].prototype.pointArrayMap;
                "undefined" === typeof l && (l = ["y"]);
                this.valueCount = { global: b(e), xColumns: k, individual: g, seriesBuilders: c, globalPointArrayMap: l };
            }
            dataFound() {
            ...
            parseCSV(a) {
                function f(a, f, e, l) {
                    ...
                    function b() {
                        z > w || w > p
                            ? (++w, (u = ""))
                            : (!isNaN(parseFloat(u)) && isFinite(u) ? ((u = parseFloat(u)), c("number")) : isNaN(Date.parse(u)) ? c("string") : ((u = u.replace(/\//g, "-")), c("date")),
                              g.length < t + 1 && g.push([]),
                              e || (g[t][f] = u),
                              (u = ""),
                              ++t,
                ...
                function k(a) {
                    ...
                    k = m[";"] > m[","] ? ";" : ",";
                    c.decimalPoint || ((c.decimalPoint = f > l ? "." : ","), (e.decimalRegex = new RegExp("^(-?[0-9]+)" + c.decimalPoint + "([0-9]+)$")));
                    return k;
                }
                function b(a, f) {
                    const l = [],
                    ...
                    for (; n < f; n++)
                        if ("undefined" !== typeof a[n] && a[n] && a[n].length)
                            for (b = a[n].trim().replace(/\//g, " ").replace(/\-/g, " ").replace(/\./g, " ").split(" "), g = ["", "", ""], d = 0; d < b.length; d++)
                                d < g.length &&
                                    ((b[d] = parseInt(b[d], 10)),
                                    b[d] &&
                                        ((k[d] = !k[d] || k[d] < b[d] ? b[d] : k[d]),
                                        "undefined" !== typeof l[d] ? l[d] !== b[d] && (l[d] = !1) : (l[d] = b[d]),
                                        31 < b[d] ? (g[d] = 100 > b[d] ? "YY" : "YYYY") : 12 < b[d] && 31 >= b[d] ? ((g[d] = "dd"), (m = !0)) : g[d].length || (g[d] = "mm")));
                    if (m) {
                    ...
                    [].forEach.call(a.getElementsByTagName("tr"), (a, f) => {
                        f >= k &&
                            ...
                            [].forEach.call(a.children, (a, c) => {
                                const b = l[c - e];
                                let d = 1;
                                if (("TD" === a.tagName || "TH" === a.tagName) && c >= e && c <= g) for (l[c - e] || (l[c - e] = []), l[c - e][f - k] = a.innerHTML; f - k >= d && void 0 === b[f - k - d]; ) (b[f - k - d] = null), d++;
                            });
                    }),
                    this.dataFound());
                return l;
            ...
            parseGoogleSpreadsheet() {
                ...
                d &&
                    ...
                    a(function (a) {
                        ...
                        e && e.series ? e.update({ data: { columns: a } }) : ((c.columns = a), c.dataFound());
                    }));
                return !1;
            }
            trim(a, b) {
            ...
            parseColumn(a, b) {
                ...
                for (c[b] || (c[b] = []); m--; ) {
                    ...
                    l || (0 === m && e && !r)
                        ? (a[m] = "" + v)
                        : +x === q
                        ? ((a[m] = q), 31536e6 < q && "float" !== h ? (a.isDatetime = !0) : (a.isNumeric = !0), "undefined" !== typeof a[m + 1] && (w = q > a[m + 1]))
                          ...
                          g && J(t) && "float" !== h
                              ? ((d[m] = y),
                                ...
                                "undefined" !== typeof a[m + 1] &&
                                    ...
                                    y !== w &&
                                        "undefined" !== typeof w &&
                                        (this.alternativeFormat ? ((this.dateFormat = this.alternativeFormat), (m = a.length), (this.alternativeFormat = this.dateFormats[this.dateFormat].alternative)) : (a.unsorted = !0)),
                                    (w = y)))
                              : ((a[m] = "" === v ? null : v), 0 !== m && (a.isDatetime || a.isNumeric) && (a.mixed = !0)));
                }
                g && a.mixed && (f[b] = c[b]);
                if (g && w && this.options.sort) for (b = 0; b < f.length; b++) f[b].reverse(), e && f[b].unshift(f[b].pop());
            }
            parseDate(a) {
            ...
            complete() {
                ...
                if (b.complete || b.afterComplete) {
                    ...
                    h = [];
                    {
                        ...
                        for (q = 0; q < p.length; q += 1) for (b = p[q].getReferencedColumnIndexes(), g = 0; g < b.length; g += 1) e[b[g]] = !1;
                        for (g = 0; g < e.length; g += 1) e[g] && r.push(g);
                    }
                    for (e = 0; e < this.valueCount.seriesBuilders.length; e++) (p = this.valueCount.seriesBuilders[e]), p.populateColumns(r) && c.push(p);
                    for (; 0 < r.length; ) {
                        p = new K();
                    ...
                    if ("category" === d) for (e = 0; e < c.length; e++) for (p = c[e], r = 0; r < p.readers.length; r++) "x" === p.readers[r].configName && (p.readers[r].configName = "name");
                    ...
                    M(f, {
                        afterComplete: function (a) {
                            ...
                            if (Object.hasOwnProperty.call(e, "series"))
                                if ("object" === typeof e.series) for (d = Math.max(e.series.length, a && a.series ? a.series.length : 0); d--; ) (f = e.series[d] || {}), (e.series[d] = x(f, a && a.series ? a.series[d] : {}));
