...
def is_point_in_polygon(left_wrist, right_wrist, polygon,frame):
    pointl = Point(left_wrist.x, left_wrist.y)
    pointr = Point(right_wrist.x, right_wrist.y)
    for poly in Polygon:
...
def process_frame(frame):
    ...
    for box in hb:
            ...
            if results.pose_landmarks: #and face_detected:
                ...
                frame = is_point_in_polygon(lw,rw,railingArray,frame)
...
railingArray = []
railingArray.append(Polygon(left_railing_coords))
railingArray.append(Polygon(right_railing_coords))
railingArray.append(Polygon(right_1_railing_coords))
